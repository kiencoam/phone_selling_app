...
const OrderConfirmation = () => {
  ...
  // Kiểm tra xem có phải thanh toán chuyển khoản không
  ...
  const handleCancelOrder = async () => {
    try {
      ...
      if (error.response && error.response.data) {
        showToast(`Lỗi: ${error.response.data.meta?.message || 'Không thể hủy đơn hàng'}`, 'error');
      } else {
        showToast('Có lỗi xảy ra khi hủy đơn hàng. Vui lòng thử lại sau.', 'error');
      }
    } finally {
  ...
  useEffect(() => {
    // Kiểm tra nếu không có thông tin đơn hàng, chuyển về trang chủ
        ...
        <div className="order-success-content">
          <div className="thank-you-section">
            <p className="thank-you-message">
              Cảm ơn Quý khách {orderInfo?.receiveName || 'Quý khách'} đã cho Thế Giới Di Động cơ hội được phục vụ
            </p>
          </div>
          ...
          <div className="order-info-box">
            <div className="order-info-header">
              ...
              <div className="order-actions">
                <span className="action-link" onClick={() => navigate('/orders')}>Quản lý đơn hàng</span>
            ...
            <ul className="order-details-list">
              <li className="order-detail-item">
                ...
                <span className="detail-value">{orderInfo?.receiveName || ''}, {orderInfo?.phone || ''}</span>
              </li>
              ...
              {orderInfo?.receiveMethod === 'DELIVERY' && (
                <li className="order-detail-item">
                  ...
                  <span className="detail-value">{orderInfo?.address || ''} (nhân viên sẽ gọi xác nhận trước khi giao)</span>
                </li>
              )}
              ...
              {orderInfo?.receiveMethod === 'PICKUP' && (
                <li className="order-detail-item">
                  ...
                  <span className="detail-value">Siêu thị Thế Giới Di Động gần nhất (nhân viên sẽ gọi xác nhận)</span>
                </li>
              )}
              <li className="order-detail-item total-amount">
                <span className="detail-bullet">•</span>
                <span className="detail-label">Tổng tiền:</span>
                <span className="detail-value highlight">{formatPrice(orderInfo?.totalPrice || 0)}</span>
              </li>
            </ul>
          </div>
          ...
          <div className="payment-method-info">
            ...
            <span className="payment-method-value">
              {orderInfo?.paymentMethod === 'CASH' && 'Thanh toán khi nhận hàng'}
              {orderInfo?.paymentMethod === 'BANK_TRANSFER' && 'Thanh toán tại siêu thị gần nhất'}
          ...
          <div className="order-actions-footer">
            ...
            <button className="action-button orders" onClick={() => navigate('/orders')}>
        ...
        <div className="modal-overlay">
          <div className="cancel-modal">
            ...
            <div className="cancel-modal-body">
              ...
              <p className="cancel-warning">Lưu ý: Hành động này không thể hoàn tác sau khi xác nhận.</p>
            </div>
      ...
      {toast.show && (
        <div className={`toast-notification ${toast.type}`}>
          <div className="toast-content">
            ...
            {toast.type === 'error' && <FaExclamationTriangle className="toast-icon" />}
